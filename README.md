...
> 🏆 **포스코 청년 AI·Big Data 아카데미 32기 최우수상 (AI 부문) 수상작** — 스마트폰 한 대로 방의 음향 지문(xRIR)을 측정하고 영상 장면의 감정을 실시간 분석해 홈 시네마 사운드를 자동 보정하는 투 트랙(공간 + 콘텐츠) 시스템입니다. **공간 인식**으로 **1024차원 공간 음향 지문**과 Inverse EQ를, **콘텐츠 인식**으로 씬 감정 기반 **Dual-Layer EQ + VAD 기반 Dialogue Protection**을 제공하며, 블라인드 A/B 청취 평가에서 **40명 중 32명(80%)이 시스템 적용본을 선호**했습니다.
